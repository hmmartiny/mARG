...
rule all:
	input:
		...
		expand("results/kma_resfinder/paired_end/{paired_reads}/{paired_reads}.bam", paired_reads=paired),
		...
		expand("results/kma_resfinder/single_end/{single_reads}/{single_reads}.bam", single_reads=single),
		...
		expand("results/kma_silva/paired_end/{paired_reads}/{paired_reads}.bam", paired_reads=paired),
		...
		expand("results/kma_silva/single_end/{single_reads}/{single_reads}.bam", single_reads=single),
		...
		expand("results/kma_gigaRes/paired_end/{paired_reads}/{paired_reads}.bam", paired_reads=paired),
		...
		expand("results/kma_gigaRes/single_end/{single_reads}/{single_reads}.bam", single_reads=single),
		...
		expand("results/kma_genomic/paired_end/{paired_reads}/{paired_reads}.bam", paired_reads=paired),
		...
		expand("results/kma_genomic/single_end/{single_reads}/{single_reads}.bam", single_reads=single),
