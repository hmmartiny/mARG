...
rule all:
	input:
		...
		expand("results/kma_virulence/paired_end/{paired_reads}/{paired_reads}.bam", paired_reads=paired),
		...
		expand("results/kma_virulence/single_end/{single_reads}/{single_reads}.bam", single_reads=single),
